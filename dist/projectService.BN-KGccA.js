import { h as getSupabaseClient } from "./card.CDyno8a4.js";
const projectDataList = [{
  ...
  galleryImageUrls: ["https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/eb1d3d8e-7b70-474e-bf67-53fdd55a2922.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/4dde789d-cf72-4489-b4a1-c0315bd97476.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/326a7ee5-5c41-4909-b56e-ea49284b1a51.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/544f82c4-aaea-4dd2-874c-ebe83c90baf3.png"],
  featured: false,
  sortOrder: 7
}, {
  ...
  galleryImageUrls: ["https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/fb79b731-10a4-4ef1-a0af-e7a29b7854f3.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/26d15500-0e42-4d3a-b8b9-37a0768b55da.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/0c61a606-1b63-49f5-836c-7085f67565b2.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/315a2a2e-b68d-41fd-8e5b-0c9108e5b90b.png"],
  featured: false,
  sortOrder: 8
}, {
  ...
  galleryImageUrls: ["https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/65beb335-aabe-4c6c-bcac-86a83e63d188.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/b1796d32-bec9-4685-aa1c-e00cf4793508.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/9ac83ff7-523d-41bc-a006-2b879d9a6661.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/6caab0e1-ce09-41cc-a414-c9d88e46914b.png"],
  featured: false,
  sortOrder: 9
}, {
  ...
  galleryImageUrls: ["https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/50b9f2da-5e06-4675-b82f-ad76f7ec1f58.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/4b6d40b1-bad4-4481-9cdc-74bf550ac5f6.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/9f4b4e15-9a73-464a-9f1f-3cc86057c1d7.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/6231cb91-cf61-4c78-bed3-73f3b74c0faa.png"],
  featured: false,
  sortOrder: 10
}, {
  ...
  galleryImageUrls: ["https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/f6d41b4b-4ec7-4410-8e8a-bbb873bf83d9.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/dcf1184b-f6dd-4faa-8b4e-b79743b4aec8.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/b4c6ef4a-b820-4eea-80a9-f2d348e3c371.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/0b6bfe4b-8c86-4e1a-882e-9c213f351efc.png"],
  featured: false,
  sortOrder: 11
}, {
  ...
  galleryImageUrls: ["https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/b0900f41-c21a-48fb-9d2d-cb0df9ceec69.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/6a8c5ac7-80ce-41c0-8d75-bb197b23ea34.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/8d1acc67-dbc0-4bb1-83c3-2ec7ecd33e0f.png", "https://spark-builder.s3.us-east-1.amazonaws.com/image/2026/4/26/1d89d5b3-8565-45dc-831f-2a91f1b4daf5.png"],
  featured: false,
  sortOrder: 12
}];
function getAll() {
...
function query(params) {
  ...
  return getAll().filter((item) => {
    const matchKeyword = !keyword || [item.title, item.category, item.location, item.scopeSummary, item.challengeSummary, item.solutionSummary, item.resultsSummary].join(" ").toLowerCase().includes(keyword);
...
async function fetchAllShared() {
  ...
  const {
    data,
    error
  } = await supabase.from(PROJECTS_TABLE).select("*").order("sortOrder", {
    ascending: true
  });
  if (error || !data) {
...
async function replaceAllShared(items) {
  ...
  const {
    error: upsertError
  } = await supabase.from(PROJECTS_TABLE).upsert(items, {
    onConflict: "id"
  });
  ...
  if (ids.length > 0) {
    const {
      error: cleanupError
    } = await supabase.from(PROJECTS_TABLE).delete().not("id", "in", `(${ids.map((id) => `"${id}"`).join(",")})`);
    if (cleanupError) {
    ...
    const {
      error: clearError
    } = await supabase.from(PROJECTS_TABLE).delete().neq("id", "");
    if (clearError) {
...
function subscribeToSharedProjects(onChange) {
  const supabase = getSupabaseClient();
  if (!supabase) return () => void 0;
  const channel = supabase.channel("projects-realtime").on("postgres_changes", {
    event: "*",
    schema: "public",
...
export {
  fetchAllShared as f,
  getById as g,
  projectDataList as p,
  query as q,
  replaceAllShared as r,
  subscribeToSharedProjects as s
};
